...
## Permissions
The extension requires access to specific websites (youtube.com, instagram.com, twitter.com) solely to modify their user interface. These permissions are used exclusively for:
- Removing distracting elements from the page
- Modifying the layout to enhance focus
- Implementing custom filtering options

No data from these sites is collected or transmitted.
